...
const lightColor = '#FEEDBC'
const mainColor = '#F9B800'
    ...
    >
      ...
      >
        <div className="lg:flex-1 lg:max-w-[552px] mb-24 flex flex-col gap-[60px] justify-center">
          <div id="content" className="[&_p]:mb-5" style={{ color: mainColor }}>
            <p>
            ...
            <p>
              ...
              en base de datos, son aleatorios, pero deben ser los que están en
              el prototipo.
            </p>

            <p>
              Los colores tienen nombre y un hexadecimal, el cuál va a ser valor
              que reemplaze todos los elementos que tengan la variable yellow
              (#F9BB00) en el prototipo.
            </p>

            <p>
              Los servicios de un color los puedo encontrar en la ruta /:color,
              si no existe el param con el color ingresado en la URL me redirige
              al 404. Pero no debe ser el 404 que tiene NEXT js por defecto sino
              una pantalla completamente negra, donde solo se vea el logo, en la
              posiciòn superior izquierda como en esta página.
            </p>
